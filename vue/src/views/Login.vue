<template>
  <div class="bg">
    <div style="width:350px ;background-color: #7eeadd ; border-radius: 5px ;box-shadow: 0 0 10px rgba(0,0,0,0.1);padding: 20px">
      <el-form ref="formRef" :model="data.form":rules="data.rules">
        ...
        <div style="text-align: right">
          还没有账号？请<a style="color:blue" href="/register">注册</a>
        </div>
      </el-form>
    </div>
  </div>
